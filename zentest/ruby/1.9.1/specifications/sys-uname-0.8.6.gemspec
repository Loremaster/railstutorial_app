...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = [%q{CHANGES}, %q{README}, %q{MANIFEST}, %q{doc/uname.txt}, %q{ext/sys/uname.c}]
  s.files = [%q{CHANGES}, %q{README}, %q{MANIFEST}, %q{doc/uname.txt}, %q{ext/sys/uname.c}, %q{ext/extconf.rb}]
